...
import Dealer, { IDealer } from "./dealer.model.js";
import { exportToCSV, exportToExcel } from "../../utils/exportUtils.js";

// Get all dealers
export const getAllDealers = async (_req: Request, res: Response): Promise<Response> => {
  try {
...
// Get dealer by ID
export const getDealerById = async (req: Request, res: Response): Promise<Response> => {
  try {
...
export const searchByPostalCode = async (req: Request, res: Response): Promise<Response> => {
  try {
...
export const searchByPlace = async (req: Request, res: Response): Promise<Response> => {
  try {
...
export const searchByRadius = async (req: Request, res: Response): Promise<Response> => {
  try {
...
export const filterByManufacturer = async (req: Request, res: Response): Promise<Response> => {
  try {
...
// Create a new dealer
export const createDealer = async (req: Request, res: Response): Promise<Response> => {
  try {
...
// Update a dealer
export const updateDealer = async (req: Request, res: Response): Promise<Response> => {
  try {
...
// Delete a dealer
export const deleteDealer = async (req: Request, res: Response): Promise<Response> => {
  try {
...
export const exportDealersCSV = async (req: Request, res: Response): Promise<void> => {
  try {
    const { postalCode, place, manufacturer } = req.query;
    let dealers: IDealer[] | undefined;
...
export const exportDealersExcel = async (req: Request, res: Response): Promise<void> => {
  try {
    const { postalCode, place, manufacturer } = req.query;
    let dealers: IDealer[] | undefined;
